...
class ParamConfig:
    ...
    def __init__(self, param_dict):
        ...
        self.linear_schedule_start = 1.0
        self.linear_schedule_end = 0.1
        self.linear_schedule_steps = 10000
        ...
        # option-critic
        self.termination_reg = 0.
        self.policy_over_options_weight = 1.
        self.option_value_weight = 1.
        self.intra_option_policy_weight = 1.
        self.termination_condition_weight = 1.
        
        # stochastic option-critic
        self.num_options = None
        self.return_tc = False
        
        # value complexity option critic
        self.l0_lamba = None
        self.l0_weight_decay = None
        self.l0_cost_weight = None
        
        # differential methods
        self.diff_methods_eta = None
